...
# test_llm_summarizer.py -> summarizer/ -> processing/ -> rag/ -> unit_tests/ -> tests/ -> project_root
...
def mock_prompt_loader():
    ...
    with patch('rag.processing.summarizer.llm_summarizer.PromptLoader.read_file') as mock_read:
...
class TestLLMSummarizer:
    ...
    def test_get_summary_prompt(self, mock_prompt_loader):
        ...
        mock_prompt_loader.assert_called_once_with("src/rag/processing/summarizer/summarizer_prompt.md")
