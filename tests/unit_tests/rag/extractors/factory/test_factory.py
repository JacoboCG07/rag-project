...
# test_factory.py -> factory/ -> extractors/ -> rag/ -> unit_tests/ -> tests/ -> project_root
...
from rag.extractors.factory import DocumentExtractorFactory
from rag.extractors.pdf import PDFExtractor
from rag.extractors.txt import TXTExtractor
from rag.extractors.base import BaseDocumentExtractor  # pyright: ignore[reportMissingImports]
