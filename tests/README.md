...
# TXT extractor tests (file)
pytest tests/unit_tests/ingestion/extractors/test_txt_extractor.py
```
...
pytest tests/unit_tests/ingestion/extractors/test_txt_extractor.py::TestTXTExtractor::test_extract

# Run a specific test class
pytest tests/unit_tests/ingestion/extractors/test_txt_extractor.py::TestTXTExtractor
```
...
**Output example:**
```
tests/unit_tests/ingestion/extractors/test_txt_extractor.py::TestTXTExtractor::test_init PASSED
tests/unit_tests/ingestion/extractors/test_txt_extractor.py::TestTXTExtractor::test_get_metadata PASSED
```
...
```bash
pytest tests/unit_tests/ingestion/extractors/test_txt_extractor.py::TestTXTExtractor::test_extract -v -s
```
...
```bash
pytest tests/unit_tests/ingestion/extractors/test_txt_extractor.py -v
```
