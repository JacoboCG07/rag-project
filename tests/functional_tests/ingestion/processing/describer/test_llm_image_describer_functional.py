...
$env:PYTHONPATH="$PWD"; pytest tests/functional_tests/ingestion/processing/describer/test_llm_image_describer_functional.py
"""
import pytest
import os
import base64
...
from src.llms.vision.openai_vision_model import OpenAIVisionModel, OPENAI_AVAILABLE
